...
class TicTacToeEnv:
    ...
    def reset(self):
        ...
        self.done = False
        self.winner = None
        self.current_player = 1  # Gracz zaczyna pierwszy
...
for episode in range(num_episodes):
    ...
    while not done:
        ...
        # draw_table(next_state)
        
        # Sprawdzenie nieprawidłowego ruchu
    ...
    print(f"Epizod {episode+1}/{num_episodes}, Aktualna nagroda: {episode_reward,} Łączna nagroda: {total_reward}, Epsilon: {epsilon:.4f}")

# model_path = "policy_net2.pth"
